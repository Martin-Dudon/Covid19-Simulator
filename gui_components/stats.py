...
def updatestats(n,l,U):
    total_cas = tk.Label(U[0], text="Total des Cas", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="#F6C82B")
    total_cas.grid(row=0, column=0,padx=0.0195*l)
    total_casnb = tk.Label(U[0], text=str(int(I[n])), bg="#202020", font=("Helvetica Neue",int(0.016*l),"bold"),width=int(0.01*l), fg="#F6C82B",)
    total_casnb.grid(row=1, column=0)
    jr_cas = tk.Label(U[0],text=f"{int(I[n+1]-I[n])} /jrs", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="#F6C82B")
    ...
    total_gueri = tk.Label(U[2], text="Immunisés", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="green")
    total_gueri.grid(row=0, column=0,padx=0.0195*l)
    total_guerinb = tk.Label(U[2], text=str(int(R[n])), bg="#202020", font=("Helvetica Neue",int(0.016*l),"bold"),width=int(0.01*l), fg="green")
    total_guerinb.grid(row=1, column=0)
    jr_gueri = tk.Label(U[2],text=f"{int(R[n+1]-R[n])} /jrs", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="green")
    jr_gueri.grid(row=2, column=0, pady=(0,0.006*l))

    total_hos= tk.Label(U[3], text="Hospitalisés", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="orange")
    total_hos.grid(row=0, column=0,padx=0.0195*l)
    total_hosnb = tk.Label(U[3], text=str(int(I2[n])), bg="#202020", font=("Helvetica Neue",int(0.016*l),"bold"),width=int(0.01*l), fg="orange")
    total_hosnb.grid(row=1, column=0)
    jr_hos = tk.Label(U[3],text=f"{int(I2[n+1]-I2[n])} /jrs", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="orange")
    jr_hos.grid(row=2, column=0, pady=(0,0.006*l))

    total_rea= tk.Label(U[4], text="Réanimation", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="red")
    total_rea.grid(row=0, column=0,padx=0.0195*l)
    total_reanb = tk.Label(U[4], text=str(int(I3[n])), bg="#202020", font=("Helvetica Neue",int(0.016*l),"bold"),width=int(0.01*l), fg="red")
    total_reanb.grid(row=1, column=0)
    jr_rea = tk.Label(U[4],text=f"{int(I3[n+1]-I3[n])} /jrs", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="red")
    jr_rea.grid(row=2, column=0, pady=(0,0.006*l))

    total_dc= tk.Label(U[5], text="Décès", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.01*l), fg="black")
    total_dc.grid(row=0, column=0,padx=0.0195*l)
    total_dcnb = tk.Label(U[5], text=str(int(D[n])), bg="#202020", font=("Helvetica Neue",int(0.016*l),"bold"),width=int(0.01*l), fg="black")
    ...
    total_assy= tk.Label(U[6], text="Asymptomatiques", bg="#202020", font=("Helvetica Neue", int(0.013*l),"bold"),width=int(0.015*l), fg="#2FC1DE")
    total_assy.grid(row=0, column=0,padx=0.005*l)
    total_assynb = tk.Label(U[6], text=str(int(I0[n])), bg="#202020", font=("Helvetica Neue",int(0.016*l),"bold"),width=int(0.01*l), fg="#2FC1DE")
