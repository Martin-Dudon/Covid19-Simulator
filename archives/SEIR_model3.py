...
def newvalues(n):
    ...
    #Notre programme étant développé avec le langage de programmation Python, nous avons donc réalisé a l'aide le module Tkinter 
    # une interface graphique simple et facile à utiliser, afin de la rendre accessible au plus grand nombre.
