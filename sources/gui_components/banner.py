...
def banner(mainapp,l):
    ...
    frame.grid(row=0,column=0,columnspan=2,padx=0.009*l,pady=0.009*l,sticky=tk.W)
    ...
    # Logo Covid
    global img
    img = tk.PhotoImage(file="sources/data/coronavirus.png")
